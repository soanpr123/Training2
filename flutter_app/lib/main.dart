...
import 'package:flutterapp/websocket.dart';
import 'package:flutterapp/websocket2.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _connectSocket01() {
    SimpleWebSocket2("https://uoi.bachasoftware.com");
  }
_connectSoket03()async{
 SimpleWebSocket("https://uoi.bachasoftware.com");
await _soket.connected();
}
  ...
  _connectSocket02() {
    socketIO02 = SocketIOManager().createSocketIO(
        "https://uoi.bachasoftware.com", "/socket-chat/",
        query:
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTI3LCJyb2xlIjoiYWRtaW4iLCJlbWFpbCI6ImFuaGRoLmJoc29mdEBnbWFpbC5jb20iLCJpYXQiOjE1OTA1NDMxOTksImV4cCI6MTU5MDYyOTU5OX0.YthX83zEG0tIu9g-0M_cLkBGTzy4SJWr86iozygK8aY",
...
//                _sendChatMessage(mTextMessageController.text);
            ...
            new RaisedButton(
              child: const Text('CONNECT  SOCKET 03',
                  style: TextStyle(color: Colors.white)),
              color: Theme.of(context).accentColor,
              elevation: 0.0,
              splashColor: Colors.blueGrey,
