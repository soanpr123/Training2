...
class Data {
  ...
  Map<String, Bl> airlineDataMap;
  Map<String, AirportDataMap> airportDataMap;
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        airlineDataMap:
            Map.from(json["airlineDataMap"]).map((k, v) => MapEntry<String, Bl>(k, Bl.fromJson(v))),
        airportDataMap: Map.from(json["airportDataMap"])
            .map((k, v) => MapEntry<String, AirportDataMap>(k, AirportDataMap.fromJson(v))),
        ...
        searchResults:
            List<SearchResult>.from(json["searchResults"].map((x) => SearchResult.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "airportDataMap":
            Map.from(airportDataMap).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
...
class AirportDataMap {
  ...
  factory AirportDataMap.fromJson(Map<String, dynamic> json) => AirportDataMap(
...
class SearchResult {
  ...
  factory SearchResult.fromJson(Map<String, dynamic> json) => SearchResult(
        connectingFlightRoutes: List<ConnectingFlightRoute>.from(
            json["connectingFlightRoutes"].map((x) => ConnectingFlightRoute.fromJson(x))),
        flightMetadata: List<FlightMetadatum>.from(
            json["flightMetadata"].map((x) => FlightMetadatum.fromJson(x))),
...
class AgentFareInfo {
  ...
  factory AgentFareInfo.fromJson(Map<String, dynamic> json) => AgentFareInfo(
        ...
        detailedSearchFares: List<AgentFareInfoDetailedSearchFare>.from(
            json["detailedSearchFares"].map((x) => AgentFareInfoDetailedSearchFare.fromJson(x))),
      );
...
class AgentFareInfoDetailedSearchFare {
  ...
  factory AgentFareInfoDetailedSearchFare.fromJson(Map<String, dynamic> json) =>
      AgentFareInfoDetailedSearchFare(
...
class AirlineFareInfo {
  ...
  factory AirlineFareInfo.fromJson(Map<String, dynamic> json) => AirlineFareInfo(
        ...
        detailedSearchFares: List<AirlineFareInfoDetailedSearchFare>.from(
            json["detailedSearchFares"].map((x) => AirlineFareInfoDetailedSearchFare.fromJson(x))),
      );
...
class AirlineFareInfoDetailedSearchFare {
  ...
  factory AirlineFareInfoDetailedSearchFare.fromJson(Map<String, dynamic> json) =>
      AirlineFareInfoDetailedSearchFare(
        ancillaryFare: AncillaryFare.fromJson(json["ancillaryFare"]),
        flightRouteFares: Map.from(json["flightRouteFares"])
            .map((k, v) => MapEntry<String, DesktopPrice>(k, DesktopPrice.fromJson(v))),
      );

  Map<String, dynamic> toJson() => {
        "ancillaryFare": ancillaryFare.toJson(),
        "flightRouteFares":
            Map.from(flightRouteFares).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
      };
}
...
class ConnectingFlightRoute {
  ...
  factory ConnectingFlightRoute.fromJson(Map<String, dynamic> json) => ConnectingFlightRoute(
        ...
        routeInventories: List<RouteInventory>.from(
            json["routeInventories"].map((x) => RouteInventory.fromJson(x))),
...
class Segment {
  ...
  factory Segment.fromJson(Map<String, dynamic> json) => Segment(
        ...
        operatingAirlineCode:
            json["operatingAirlineCode"] == null ? null : json["operatingAirlineCode"],
        fareBasisCode: json["fareBasisCode"] == null ? null : json["fareBasisCode"],
        segmentInventories: List<SegmentInventory>.from(
            json["segmentInventories"].map((x) => SegmentInventory.fromJson(x))),
        ...
        aircraftInformation: AircraftInformation.fromJson(json["aircraftInformation"]),
...
class AircraftInformation {
  ...
  factory AircraftInformation.fromJson(Map<String, dynamic> json) => AircraftInformation(
        ...
        cabinBaggage: FreeBaggageInfo.fromJson(json["cabinBaggage"]),
      );

  Map<String, dynamic> toJson() => {
        "aircraft": aircraft == null ? null : aircraft.toJson(),
        "cabinBaggage": cabinBaggage.toJson(),
      };
}
...
class Aircraft {
  ...
  factory Aircraft.fromJson(Map<String, dynamic> json) => Aircraft(
        ...
        seatInformation: SeatInformation.fromJson(json["seatInformation"]),
      );
...
class DataFlight {
  ...
  DataFlight({this.flightModel, this.b1, this.airportDataMap});
}
